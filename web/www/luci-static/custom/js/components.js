...
(function (win) {
    ...
    var STYLE_CSS = [
        ...
        '    --adui-ss-bg: #0f141d;',
        '    --adui-ss-border: #2b3440;',
        '    --adui-ss-focus-border: #4d90ff;',
        '    --adui-ss-focus-shadow: rgba(77, 144, 255, .18);',
        '    --adui-ss-text: #e6f0ff;',
        '    --adui-ss-placeholder: #888;',
        '    --adui-ss-arrow-color: #aaa;',
        ...
        '    --adui-ss-menu-divider: rgba(167, 190, 216, .15);',
        '    position: relative;',
        ...
        '    scrollbar-color: var(--adui-ss-menu-border) #11161d;',
        '}',
        '',
        ...
        '    padding: 6px 8px;',
        '    border-radius: 6px;',
        '    border-bottom: 1px solid var(--adui-ss-menu-divider, rgba(167, 190, 216, .15));',
        '    cursor: pointer;',
        '    user-select: none;',
        '}',
        '',
        ...
        '    background: var(--adui-ss-menu-selected-bg, #2a4667);',
        '}',
        '',
        ...
        '    --adui-ms-bg: #1b1e24;',
        '    --adui-ms-border: #3a3a3a;',
        '    --adui-ms-text: #e6f0ff;',
        '    --adui-ms-placeholder: #7f93b3;',
        '    --adui-ms-arrow-color: #a7bed8;',
        '    --adui-ms-chip-bg: #20334a;',
        '    --adui-ms-chip-text: #cfe6ff;',
        '    --adui-ms-chip-border: #2a3b52;',
        '    --adui-ms-menu-bg: #1b1e24;',
        '    --adui-ms-menu-border: #3a3a3a;',
        '    --adui-ms-menu-text: #dbe8ff;',
        '    --adui-ms-menu-hover-bg: #20334a;',
        '    --adui-ms-menu-divider: rgba(167, 190, 216, .15);',
        '    --adui-ms-box-border: #4b617f;',
        '    --adui-ms-box-bg: #0f141d;',
        '    --adui-ms-box-checked: #2b77ff;',
        ...
        '    scrollbar-width: thin;',
        '    scrollbar-color: var(--adui-ms-menu-border) #11161d;',
        '}',
        '',
        ...
        '    padding: 6px 8px;',
        '    border-radius: 6px;',
        '    border-bottom: 1px solid var(--adui-ms-menu-divider, rgba(167, 190, 216, .15));',
        '    cursor: pointer;',
        '}',
        '',
