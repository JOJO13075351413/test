...
var CBINetworkSelect = form.ListValue.extend({
	...
	renderWidget: function(section_id, option_index, cfgvalue) {
		...
		var widget = new ui.Dropdown(this.multiple ? values : values[0], choices, {
			...
			create_markup: '' +
				'<li data-value="{{value}}">' +
					'<span class="ifacebadge" style="background:repeating-linear-gradient(45deg,rgba(17,17,17,0.5),rgba(17,17,17,0.5) 5px,rgba(255,255,255,0.5) 5px,rgba(255,255,255,0.5) 10px)">' +
