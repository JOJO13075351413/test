		...
		return uci.load('uhttpd').then(function() {
			...
			if ( '0' === debug_disabled ){
				return Promise.all([
					...
					fs.trimmed('/sys/kernel/debug/ieee80211/phy1/bcwifi/txq'),
					fs.trimmed('/sys/kernel/debug/ieee80211/phy1/bcwifi/hwq'),
					fs.trimmed('/sys/kernel/debug/ieee80211/phy1/bcwifi/stats'),
					fs.trimmed('/sys/kernel/debug/ieee80211/phy1/bcwifi/lmactx'),
					fs.trimmed('/sys/kernel/debug/ieee80211/phy1/bcwifi/lmacrx'),
